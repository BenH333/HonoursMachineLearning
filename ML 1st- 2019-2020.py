...
course_corr, _ = pearsonr(course_views, students_df['OVERALL_GRADE'])
...
print(covariance)
#positive covariance shows there is some linear relationship
...
print("Randdom Forest Accuracy: ",accuracy_score(y_test, y_pred))
